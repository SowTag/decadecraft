...
#ifndef DECADECRAFT_OPENGL_H
#define DECADECRAFT_OPENGL_H
#include <iostream>
#include <ostream>
...
inline void enableOpenGLDebug() {
    ...
    if (flags & GL_CONTEXT_FLAG_DEBUG_BIT) {
        ...
        std::cout << "OpenGL debug logs enabled, " << glGetString(GL_VERSION) << std::endl;
    }
}
...
inline void APIENTRY glDebugOutput(const GLenum source,
    ...
    switch (source) {
        ...
        case GL_DEBUG_SOURCE_OTHER: std::cout << "Source: Other";
            break;
        default: std::cout << "Source: unknown";
    }
    std::cout << std::endl;
    ...
    switch (severity) {
        ...
        case GL_DEBUG_SEVERITY_NOTIFICATION: std::cout << "Severity: notification";
            break;
        default: std::cout << "Severity: unknown";
    }
    std::cout << std::endl;
    std::cout << std::endl;
}

#endif //DECADECRAFT_OPENGL_H
